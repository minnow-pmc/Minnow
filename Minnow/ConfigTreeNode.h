...
#define NODE_TYPE_CONFIG_LEAF_INPUT_SWITCH_ENABLE_PULLUP  62

#define NODE_TYPE_CONFIG_LEAF_OUTPUT_SWITCH_FRIENDLY_NAME 63
#define NODE_TYPE_CONFIG_LEAF_OUTPUT_SWITCH_PIN           64
#define NODE_TYPE_CONFIG_LEAF_OUTPUT_SWITCH_INITIAL_STATE 65

#define NODE_TYPE_CONFIG_LEAF_PWM_OUTPUT_FRIENDLY_NAME    66
#define NODE_TYPE_CONFIG_LEAF_PWM_OUTPUT_PIN              67
#define NODE_TYPE_CONFIG_LEAF_PWM_OUTPUT_USE_SOFT_PWM     68

#define NODE_TYPE_CONFIG_LEAF_BUZZER_FRIENDLY_NAME        69
#define NODE_TYPE_CONFIG_LEAF_BUZZER_PIN                  70

#define NODE_TYPE_CONFIG_LEAF_TEMP_SENSOR_FRIENDLY_NAME   71
#define NODE_TYPE_CONFIG_LEAF_TEMP_SENSOR_PIN             72
#define NODE_TYPE_CONFIG_LEAF_TEMP_SENSOR_TYPE            73

#define NODE_TYPE_CONFIG_LEAF_HEATER_FRIENDLY_NAME        74
#define NODE_TYPE_CONFIG_LEAF_HEATER_PIN                  75
#define NODE_TYPE_CONFIG_LEAF_HEATER_TEMP_SENSOR          76
#define NODE_TYPE_CONFIG_LEAF_HEATER_MAX_TEMP             77
#define NODE_TYPE_CONFIG_LEAF_HEATER_POWER_ON_LEVEL       78
#define NODE_TYPE_CONFIG_LEAF_HEATER_USE_SOFT_PWM         79
#define NODE_TYPE_CONFIG_LEAF_HEATER_USE_BANG_BANG        80
#define NODE_TYPE_CONFIG_LEAF_HEATER_USE_PID              81
#define NODE_TYPE_CONFIG_LEAF_HEATER_BANG_BANG_HYSTERESIS 82
#define NODE_TYPE_CONFIG_LEAF_HEATER_PID_FUNCTIONAL_RANGE 83
#define NODE_TYPE_CONFIG_LEAF_HEATER_PID_KP               84
#define NODE_TYPE_CONFIG_LEAF_HEATER_PID_KI               85
#define NODE_TYPE_CONFIG_LEAF_HEATER_PID_KD               86
#define NODE_TYPE_CONFIG_LEAF_HEATER_PID_DO_AUTOTUNE      87
